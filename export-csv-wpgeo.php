...
$csv_labels = array(
    ...
    'linkedin',
    'contact_person',
    'mental_health_support_offering',
    'special_offers',
    'health_service_offering',
    'disability_offering',
    'perinatal_support',
    'infertility_offering',
    'URL'
);
...
while ($query->have_posts()) {
    ...
    $business_type = geodir_get_post_meta($cur_id, 'property_type', true);
    ...
    $mental_health_support_offering = geodir_get_post_meta($cur_id, 'mental_health_support_offering', true);
    $special_offers = geodir_get_post_meta($cur_id, 'special_offers', true);
    $health_service_offering = geodir_get_post_meta($cur_id, 'health_service_offering', true);
    $disability_offering = geodir_get_post_meta($cur_id, 'disability_offering', true);
    $perinatal_support = geodir_get_post_meta($cur_id, 'perinatal_support', true);
    $infertility_offering = geodir_get_post_meta($cur_id, 'infertility_offering', true);
    ...
    $terms = wp_get_post_terms($post_id, 'gd_health_listingcategory');
