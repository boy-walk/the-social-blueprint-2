	...
	class Porto_Theme_Setup_Wizard {
		...
		public function porto_demo_types() {
			...
			return array(
				...
				'shop'                 => array(
					'alt'        => 'Shop Demo <small>(50 VARIATIONS)</small>',
					'slider_cat' => 'shop',
	...
	/*			'corporate2'           => array(
		...
		/*		'corporate13'          => array(
				...
				'shop50'               => array(
					...
					'plugins' => array( 'js_composer', 'woocommerce', 'yith-woocommerce-wishlist', 'contact-form-7', 'customer-reviews-woocommerce', 'yith-woocommerce-ajax-navigation', 'perfect-woocommerce-brands' ),
				),
				'shop49'               => array(
					'alt'     => 'Shop 49',
					'img'     => $demo_img_site . '/demos/shop49.jpg',
					'filter'  => 'shop elementor soft has-badge badge-new',
					'plugins' => array( 'js_composer', 'woocommerce', 'yith-woocommerce-wishlist', 'contact-form-7', 'customer-reviews-woocommerce', 'yith-woocommerce-ajax-navigation', 'perfect-woocommerce-brands', 'yith-woocommerce-compare' ),
				),
				'shop48'               => array(
					'alt'     => 'Shop 48',
				...
				foreach ( $import_widgets as $import_widget ) :
					...
					if ( isset( $wp_registered_sidebars[ $import_sidebar ] ) ) :
						...
						if ( array_key_exists( $title, $new_widgets ) ) {
							...
							$current_widget_data[ $new_index ] = ( isset( $widget_data[ $title ][ $index ] ) ) ? $widget_data[ $title ][ $index ] : '';
