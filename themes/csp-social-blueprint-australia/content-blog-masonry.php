...
elseif ( 'hover_info' == $post_style || 'hover_info2' == $post_style ) :
	...
	?>
	<div class="grid-box">
		<div class="grid-box-featured-image card mb-0" style="position:relative;overflow:hidden;">
    ...
    z-index: 1;
    width: 70px;
    transform: translate(-50%, -50%); " src="https://thesocialblueprint.org.au/wp-content/uploads/2023/04/youtube-play-button.png"></a>
</div>
		<?php
			// Post Slideshow
		...
		?>
		<div class="post-content mb-2 mb-lg-3 p-3" style="border-width: 0 2px 2px 2px; border-color: #eee;">
			...
			<h4 class="entry-title mb-0" style="min-height: 100px;"><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h4>
			<?php
			...
			if ( ! empty( $porto_settings['blog-excerpt'] ) ) {
				...
				echo '<div class="entry-content d-none">';
				//porto_the_content();
				wp_link_pages(
					array(
			...
			<?php if ( isset( $porto_settings['blog-post-share-position'] ) && '' === $porto_settings['blog-post-share-position'] && ( 'yes' == $share || ( empty( $share ) && $social_share ) ) ) : ?>
				<div class="post-block post-share d-none">
