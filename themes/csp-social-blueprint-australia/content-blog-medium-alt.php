...
<article id="post-<?php the_ID(); ?>" <?php post_class( $post_class ); ?>>
	...
	<?php endif; ?>
			...
			<div class="post-content">
				...
				<h2 class="entry-title"><a href="<?php echo esc_url( apply_filters( 'sss', get_permalink() ) ); ?>"><?php the_title(); ?></a></h2>
			...
			<div>
				<a class="btn btn-lg btn-borders btn-primary custom-border-radius font-weight-semibold1 text-uppercase1 m-t-lg mb-5" href="<?php echo esc_url( apply_filters( 'the_permalink', get_permalink() ) ); ?>"><?php esc_html_e( 'Find out more', 'porto' ); ?></a>
			</div>
