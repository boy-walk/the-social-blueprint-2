...
<div id="content" role="main" class="porto-single-page">
	...
	if ( have_posts() ) :
		...
		if ( 'post' == $post->post_type ) :
			...
			<!-- <a onclick="history.back()" class="inline-block m-b-md" href="<?php echo get_post_type_archive_link( 'post' ); ?>"><i class="fas fa-long-arrow-alt-<?php echo ( is_rtl() ? 'right p-r-xs' : 'left p-l-xs' ); ?>"></i> <?php echo sprintf( esc_html__( 'Go Back', 'porto' ), porto_title_archive_name( 'post' ) ); ?></a><?php endif; ?> -->
			...
			if ( ! empty( $porto_settings['post-backto-blog'] ) ) :
				?>
				<?php /* translators: %s: Post archive name */ ?>
			<a onclick="history.go(-1); return false;" class="inline-block m-t-md m-b-md" href="<?php //echo get_post_type_archive_link( 'post' ); ?>"><i class="fas fa-long-arrow-alt-<?php echo ( is_rtl() ? 'right p-r-xs' : 'left p-l-xs' ); ?>"></i> <?php echo sprintf( esc_html__( 'Go Back', 'porto' ), porto_title_archive_name( 'post' ) ); ?></a>
				<?php
			endif;
