...
// 				'class'   => 'text-center text-center m-3 p-0 w-80 mx-auto',
// 				'type'    => 'info',
// 				'content' => 'Image Size: 400px width by 400px height recommended.'
// 			)
// 		);
		echo aui()->alert( array(
				'class'   => 'text-center text-center m-3 p-2 w-80 mx-auto',
				'type'    => 'info',
				'content' => sprintf( __( 'Note: Image Size: 400px width by 400px height recommended. Max upload image size: %s', 'userswp' ), $files->uwp_formatSizeUnits( $files->uwp_get_max_upload_size( $type ) ) )
			)
		);
		?>
