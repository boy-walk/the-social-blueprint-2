...
4. For detailed setup instructions, visit the official [Documentation](https://docs.wpgeodirectory.com/category/89-custom-post-types-extension/?utm_source=docs&utm_medium=installation_tab&utm_content=documentation&utm_campaign=readme) page.
