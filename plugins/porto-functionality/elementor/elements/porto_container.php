		...
		$self->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					...
					'#header.sticky-header .elementor-element-{{ID}}.header-main.sticky.e-con' => '--padding-block-start: {{SIZE}}{{UNIT}} !important; --padding-block-end: {{SIZE}}{{UNIT}} !important; padding-top: 0 !important; padding-bottom: 0 !important;',
				),
				'condition'  => array(
					'is_main_header' => 'yes',
				)
