...
if ( $settings['link'] ) {
	$show_link = true;
	$link_str = '<a href="' . esc_url( $settings['link'] ) . '"' . $type_plugin . $rel_attr . '>';
	...
	$show_link = true;
	$link_str = '<a href="' . esc_url( get_permalink() ) . '"' . $type_plugin . $rel_attr . '>';
	...
	$show_link = true;
	$link_str = '<a href="' . esc_url( get_term_link( get_queried_object() ) ) . '"' . $type_plugin . $rel_attr . '>';
}
