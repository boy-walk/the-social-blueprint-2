...
if ( function_exists( 'vc_is_inline' ) && vc_is_inline() ) {
	...
	if ( ! empty( $max_width ) ) {
		$inline_style .= '@media (max-width:' . esc_html( $max_width ) . ') {';
		$inline_style .= '#grid-' . $rand_escaped . ' .vc_porto_grid_item:first-child { margin-top: 0 }';
		$inline_style .= '#grid-' . $rand_escaped . ' .vc_porto_grid_item { width: 100% !important; position: static !important; float: none }';
		$inline_style .= '}';
	}
}
if ( $inline_style ) {
