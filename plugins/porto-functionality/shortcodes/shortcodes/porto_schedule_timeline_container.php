			...
			'params'          => array(
				...
				array(
					...
					'selectors'  => array(
						...
						'{{WRAPPER}}.process-horizontal .process-step' => '--porto-step-circle-wd: {{VALUE}}px',
					),
					'dependency' => array(
						'element' => 'type',
						'value'   => array( 'step' ),
				...
				array(
					...
					'selectors'  => array(
						...
						'{{WRAPPER}}.process-horizontal .process-step-circle' => ' margin-top:{{TOP}};margin-right:{{RIGHT}};margin-bottom:{{BOTTOM}};margin-left:{{LEFT}};',
						'{{WRAPPER}}.process-horizontal' => '--porto-step-circle-margin:{{TOP}}',
					),
					'dependency' => array(
						'element' => 'type',
						'value'   => array( 'step' ),
				...
				array(
					...
					'selectors'  => array(
						'{{WRAPPER}} .step-item-title, {{WRAPPER}}.process-horizontal .process-step-content .step-item-title',
					),
					'group'      => esc_html__( 'Item Style', 'porto-functionality' ),
				),
				array(
				...
				array(
					...
					'units'      => array( 'px', 'rem' ),
					'selectors'  => array(
						'{{WRAPPER}} .step-item-title, {{WRAPPER}} .timeline-item-title, {{WRAPPER}}.process-horizontal .process-step-content .step-item-title' => 'margin-bottom: {{VALUE}}{{UNIT}};',
					),
					'group'      => esc_html__( 'Item Style', 'porto-functionality' ),
				),
				array(
				...
				array(
					...
					'param_name' => 'item_pd',
					'selectors'  => array(
						'{{WRAPPER}} .timeline-balloon .balloon-content, {{WRAPPER}}.timeline .timeline-box' => 'padding-top: {{TOP}};padding-right: {{RIGHT}};padding-bottom: {{BOTTOM}};padding-left: {{LEFT}};',
					),
					'dependency' => array(
						'element' => 'type',
						'value'   => array( 'schedule', 'history' ),
