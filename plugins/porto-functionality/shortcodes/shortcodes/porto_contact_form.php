		...
		array(
			...
			'params'      => array(
				...
				array(
					...
					'param_name' => 'tg',
					'selectors'  => array(
						'{{WRAPPER}}, {{WRAPPER}} input, {{WRAPPER}} select, {{WRAPPER}} textarea',
					),
				...
				array(
					...
					'units'      => array( 'px', 'rem', 'em' ),
					'selectors'  => array(
						'{{WRAPPER}} input[type="text"], {{WRAPPER}} input[type="email"], {{WRAPPER}} input[type="date"], {{WRAPPER}} input[type="datetime"], {{WRAPPER}} input[type="number"], {{WRAPPER}} input[type="tel"], {{WRAPPER}} select' => 'height: {{VALUE}}{{UNIT}};',
					),
					'group'      => __( 'Form Fields', 'porto-functionality' ),
				),
				array(
				...
				array(
					...
					'units'       => array( 'px', 'rem', 'em' ),
					'selectors'   => array(
						'{{WRAPPER}} input[type="text"], {{WRAPPER}} input[type="email"], {{WRAPPER}} input[type="date"], {{WRAPPER}} input[type="datetime"], {{WRAPPER}} input[type="number"], {{WRAPPER}} input[type="tel"], {{WRAPPER}} textarea, {{WRAPPER}} .form-control, {{WRAPPER}} select' => 'font-size: {{VALUE}}{{UNIT}};',
					),
					'group'       => __( 'Form Fields', 'porto-functionality' ),
				),
				array(
					...
					'param_name'  => 'clr',
					'selectors'   => array(
						'{{WRAPPER}} input[type="text"], {{WRAPPER}} input[type="email"], {{WRAPPER}} input[type="date"], {{WRAPPER}} input[type="datetime"], {{WRAPPER}} input[type="number"], {{WRAPPER}} input[type="tel"], {{WRAPPER}} textarea, {{WRAPPER}} .form-control, {{WRAPPER}} select' => 'color: {{VALUE}};',
					),
					'group'       => __( 'Form Fields', 'porto-functionality' ),
				),
				array(
				...
				array(
					...
					'selectors'   => array(
						'{{WRAPPER}} input[type="text"], {{WRAPPER}} input[type="email"], {{WRAPPER}} input[type="date"], {{WRAPPER}} input[type="datetime"], {{WRAPPER}} input[type="number"], {{WRAPPER}} input[type="tel"], {{WRAPPER}} textarea, {{WRAPPER}} .form-control, {{WRAPPER}} select' => 'background-color: {{VALUE}};',
					),
					'group'       => __( 'Form Fields', 'porto-functionality' ),
				),
				array(
					...
					'param_name'  => 'field_bw',
					'selectors'   => array(
						'{{WRAPPER}} input[type="text"], {{WRAPPER}} input[type="email"], {{WRAPPER}} input[type="date"], {{WRAPPER}} input[type="datetime"], {{WRAPPER}} input[type="number"], {{WRAPPER}} input[type="tel"], {{WRAPPER}} textarea, {{WRAPPER}} .form-control, {{WRAPPER}} select' => 'border-top-width: {{TOP}};border-right-width: {{RIGHT}};border-bottom-width: {{BOTTOM}};border-left-width: {{LEFT}};',
					),
					'group'       => __( 'Form Fields', 'porto-functionality' ),
				),
				array(
					...
					'param_name'  => 'field_bc',
					'selectors'   => array(
						'{{WRAPPER}} input[type="text"], {{WRAPPER}} input[type="email"], {{WRAPPER}} input[type="date"], {{WRAPPER}} input[type="datetime"], {{WRAPPER}} input[type="number"], {{WRAPPER}} input[type="tel"], {{WRAPPER}} textarea, {{WRAPPER}} .form-control, {{WRAPPER}} select' => 'border-color: {{VALUE}};',
					),
					'group'       => __( 'Form Fields', 'porto-functionality' ),
				),
				array(
				...
				array(
					...
					'param_name' => 'btn_pd',
					'selectors'  => array(
						'{{WRAPPER}} button, {{WRAPPER}} .btn, {{WRAPPER}} input[type="button"], {{WRAPPER}} input[type="submit"]' => 'padding-top: {{TOP}}; padding-right: {{RIGHT}}; padding-bottom: {{BOTTOM}}; padding-left: {{LEFT}};',
					),
					'group'      => __( 'Buttons', 'porto-functionality' ),
				),
				array(
