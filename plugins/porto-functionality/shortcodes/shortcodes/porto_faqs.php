		...
		array(
			...
			'params'      => array(
				...
				array(
					...
					'value'      => '',
					'selectors'  => array(
						'{{WRAPPER}} .toggle' => 'border-top-left-radius: {{TOP}};border-top-right-radius: {{RIGHT}}; border-bottom-right-radius: {{BOTTOM}}; border-bottom-left-radius: {{LEFT}};',
					),
					'group'      => __( 'Faq', 'porto-functionality' ),
				),
				array(
				...
				array(
					...
					'value'      => '',
					'selectors'  => array(
						'{{WRAPPER}} .toggle > label' => 'padding-top: {{TOP}};padding-right: {{RIGHT}};padding-bottom: {{BOTTOM}};padding-left: {{LEFT}};',
					),
					'group'      => __( 'Title', 'porto-functionality' ),
				),
				array(
				...
				array(
					...
					'value'      => '',
					'selectors'  => array(
						'{{WRAPPER}} .toggle > label' => 'border-top-left-radius: {{TOP}};border-top-right-radius: {{RIGHT}}; border-bottom-right-radius: {{BOTTOM}}; border-bottom-left-radius: {{LEFT}};',
					),
					'group'      => __( 'Title', 'porto-functionality' ),
				),
				array(
				...
				array(
					...
					'value'      => '',
					'selectors'  => array(
						'{{WRAPPER}} .toggle > label:hover' => 'border-top-left-radius: {{TOP}};border-top-right-radius: {{RIGHT}}; border-bottom-right-radius: {{BOTTOM}}; border-bottom-left-radius: {{LEFT}};',
					),
					'group'      => __( 'Title', 'porto-functionality' ),
				),
				array(
				...
				array(
					...
					'value'      => '',
					'selectors'  => array(
						'{{WRAPPER}} .toggle.active > label' => 'border-top-left-radius: {{TOP}};border-top-right-radius: {{RIGHT}}; border-bottom-right-radius: {{BOTTOM}}; border-bottom-left-radius: {{LEFT}};',
					),
					'group'      => __( 'Title', 'porto-functionality' ),
				),
				...
				array(
					...
					'heading'     => __( 'Icon Text', 'porto-functionality' ),
					'description' => __( 'Please input css content value which will be used as toggle icon.', 'porto-functionality' ),
					'param_name'  => 'toggle_content_active1',
					'selectors'   => array(
						'{{WRAPPER}} .toggle.active > label:before' => 'content: "\\\{{VALUE}}"; border: none; line-height: 1; top: 50%;',
					),
					'dependency'  => array(
				...
				array(
					...
					'value'      => '',
					'selectors'  => array(
						'{{WRAPPER}} .toggle-content' => 'padding-top: {{TOP}};padding-right: {{RIGHT}};padding-bottom: {{BOTTOM}};padding-left: {{LEFT}};',
					),
					'group'      => __( 'Content', 'porto-functionality' ),
				),
				array(
					...
					'value'      => '',
					'selectors'  => array(
						'{{WRAPPER}} .toggle-content' => 'border-top-left-radius: {{TOP}};border-top-right-radius: {{RIGHT}}; border-bottom-right-radius: {{BOTTOM}}; border-bottom-left-radius: {{LEFT}};',
					),
					'group'      => __( 'Content', 'porto-functionality' ),
				),
				array(
