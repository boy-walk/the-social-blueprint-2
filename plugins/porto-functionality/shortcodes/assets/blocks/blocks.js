...
( function( wpI18n, wpBlocks, wpElement, wpEditor, wpBlockEditor, wpComponents, wpData, lodash ) {
	...
	registerBlockType( 'porto/porto-interactive-banner', {
		title: 'Porto Interactive Banner with Dynamic Image',
		icon: 'porto',
		category: 'porto',
		keywords: ['featured image', 'dynamic image', 'acf image', 'toolset', 'author avatar'],
		attributes: {
...
( function( wpI18n, wpBlocks, wpElement, wpEditor, wpBlockEditor, wpComponents, wpData, lodash ) {
	...
	const PortoHeading = function( props ) {
		...
		if ( attrs.line_clamp ) {
			...
			style_inline['-webkit-line-clamp'] = attrs.line_clamp;
