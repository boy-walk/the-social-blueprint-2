            ...
            ?>
                <div class="options_group">
                    <p class="form-field hide_if_grouped hide_if_external">
                        ...
                        echo sprintf( esc_html__( 'Compares Products are products which are similar to the currently viewed product. You can show these products with the %1$sLinked Products%2$s widget of %3$sSingle Product%4$s builder.', 'porto-functionality' ), '<b>', '</b>', '<a href="' . esc_url( admin_url( 'edit.php?post_type=porto_builder&porto_builder_type=product' ) ) . '" target="_blank">', '</a>' );
                        ?></span>
