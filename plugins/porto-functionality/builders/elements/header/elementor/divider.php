...
class Porto_Elementor_HB_Divider_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Porto Vertical Divider', 'porto-functionality' );
	}
	...
	public function get_icon() {
		return 'Simple-Line-Icons-control-pause porto-elementor-widget-icon';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'.elementor-element-{{ID}} .separator' => 'border-left-width: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'.elementor-element-{{ID}} .separator' => 'height: {{SIZE}}{{UNIT}};',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'.elementor-element-{{ID}} .separator' => 'border-left-color: {{VALUE}};',
				),
			)
		);
