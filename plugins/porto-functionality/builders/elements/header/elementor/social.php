...
class Porto_Elementor_HB_Social_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Porto Header Social Icons', 'porto-functionality' );
	}
		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'raw'             => sprintf( esc_html__( 'Please see %1$sTheme Options -> Header -> Social Links%2$s panel.', 'porto-functionality' ), '<a target="_blank" href="' . porto_get_theme_option_url( 'show-header-socials' ) . '"><b>', '</b></a>' ),
