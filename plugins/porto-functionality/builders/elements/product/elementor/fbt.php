		...
		$this->start_controls_section(
			...
			$this->add_control(
				...
				array(
					...
					'selectors'   => array(
						'.elementor-element-{{ID}} .yith-wfbt-section .yith-wfbt-images td img' => 'width: {{SIZE}}{{UNIT}};',
					),
			...
			$this->add_control(
				...
				array(
					...
					'selectors'   => array(
						'.elementor-element-{{ID}} .yith-wfbt-section .yith-wfbt-images .image_plus' => 'width: {{SIZE}}{{UNIT}};',
					),
			...
			$this->add_control(
				...
				array(
					...
					'selectors'   => array(
						'.elementor-element-{{ID}} .yith-wfbt-section .yith-wfbt-images .image_plus' => 'font-size: {{SIZE}}{{UNIT}};',
					),
				)
			);
