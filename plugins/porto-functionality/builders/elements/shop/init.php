	...
	class PortoBuildersShop {
		...
		public function add_elementor_elements( $self ) {
			...
			if ( is_admin() || $id ) {
				...
				if ( is_singular( PortoBuilders::BUILDER_SLUG ) && 'shop' == get_post_meta( $id, PortoBuilders::BUILDER_TAXONOMY_SLUG, true ) ) {
					$this->is_shop_builder_layout = true;
			...
			if ( apply_filters( 'porto_elementor_load_builder_widgets', $this->is_shop_builder_layout, 'shop' ) ) {
					...
					function( $atts, $content = null ) use ( $tag ) {
						...
						if ( 'products' == $tag && is_singular( PortoBuilders::BUILDER_SLUG ) ) {
							...
							if ( 'toggle' == $tag ) {
								...
								$params_keys = array( 'label_hide', 'select_hide', 'label_color', 'label_typography', 'select_color', 'select_typography', 'select_padding', 'spacing', 'select_padding', 'select_height' );
							}
							$params = array();
		...
		public function load_wpb_map_elements() {
			...
			vc_map(
				array(
					...
					'icon'        => PORTO_WIDGET_URL . 'toolbox.png',
					'class'       => 'porto-wpb-widget',
					'category'     => __( 'Shop Builder', 'porto-functionality' ),
			...
			vc_map(
				array(
					...
					'base'        => 'porto_sb_sort',
					'icon'        => PORTO_WIDGET_URL . 'sort-by.png',
					'class'       => 'porto-wpb-widget',
					'category'    => __( 'Shop Builder', 'porto-functionality' ),
					...
					'params'      => array(
						...
						array(
							...
							'hint'        => '<img src="' . PORTO_HINT_URL . 'porto_sb_sort.jpg"/>',
							'selectors'   => array(
						...
						array(
							...
							'selectors'   => array(
								'{{WRAPPER}} select' => 'padding-top: {{TOP}}; padding-right: {{RIGHT}}; padding-bottom: {{BOTTOM}}; padding-left: {{LEFT}};',
							),
						),
						array(
			...
			vc_map(
				array(
					...
					'icon'        => PORTO_WIDGET_URL . 'result-count.png',
					'class'       => 'porto-wpb-widget',
					'category'    => __( 'Shop Builder', 'porto-functionality' ),
			...
			vc_map(
				array(
					'name'        => __( 'Count Per Page ( Shop Products Count )', 'porto-functionality' ),
					'base'        => 'porto_sb_count',
					'icon'        => PORTO_WIDGET_URL . 'count-per-page.png',
					'class'       => 'porto-wpb-widget',
					'category'    => __( 'Shop Builder', 'porto-functionality' ),
					'as_child'    => array( 'only' => 'porto_sb_toolbox' ),
					'description' => __( 'This displays pagination together when pagination is disabled in Type Builder Archives element.', 'porto-functionality' ),
					'params'      => array(
						array(
							'type'       => 'porto_param_heading',
							'param_name' => 'notice_to_option',
							'text'       => __( 'Set the shop products count in Theme Options/WooCommerce/Product Archives/Products per Page.', 'porto-functionality' ),
						),
						array(
							'type'       => 'dropdown',
							'heading'    => esc_html__( 'Label Visibility', 'porto-functionality' ),
							...
							'group'      => __( 'Label', 'porto-functionality' ),
						),
						array(
							'type'        => 'colorpicker',
							'heading'     => esc_html__( 'Label Color', 'porto-functionality' ),
						...
						array(
							'type'       => 'dropdown',
							'heading'    => esc_html__( 'SelectBox Visibility', 'porto-functionality' ),
							'param_name' => 'select_hide',
							'value'      => array(
								__( 'Default', 'porto-functionality' ) => '',
								__( 'Hide', 'porto-functionality' )    => 'none',
							),
							'selectors'  => array(
								'{{WRAPPER}} .woocommerce-viewing select' => 'display: {{VALUE}};',
							),
							'group'      => __( 'Select', 'porto-functionality' ),
						),
						array(
							'heading'     => esc_html__( 'Select box Color', 'porto-functionality' ),
							'description' => esc_html__( 'Controls color of select box.', 'porto-functionality' ),
						...
						array(
							'heading'     => esc_html__( 'Select Height(px)', 'porto-functionality' ),
							'type'        => 'number',
							'param_name'  => 'select_height',
							'description' => esc_html__( 'Controls height of Select Box.', 'porto-functionality' ),
							'min'         => 0,
							'max'         => 100,
							'suffix'      => 'px',
							'selectors'   => array(
								'{{WRAPPER}} select' => 'height: {{VALUE}}px',
							),
							'dependency'  => array(
								'element'            => 'select_hide',
								'value_not_equal_to' => 'none',
			...
			vc_map(
				array(
					...
					'icon'        => PORTO_WIDGET_URL . 'grid-list-toggle.png',
					'class'       => 'porto-wpb-widget',
					...
					'params'      => array(
						array(
							...
							'hint'        => '<img src="' . PORTO_HINT_URL . 'porto_sb_toggle.jpg"/>',
							'value'      => array(
						...
						array(
							...
							'selectors'  => array(
								'{{WRAPPER}}.gridlist-toggle > a' => 'border-style: {{VALUE}};',
							),
							'group'      => __( 'Style', 'porto-functionality' ),
						),
						array(
							...
							'selectors'  => array(
								'{{WRAPPER}}.gridlist-toggle > a' => 'border-width: {{VALUE}}{{UNIT}};',
							),
							'group'      => __( 'Style', 'porto-functionality' ),
						),
						array(
			...
			vc_map(
				array(
					...
					'icon'                    => PORTO_WIDGET_URL . 'filters-toggle.png',
					'class'                   => 'porto-wpb-widget',
					'category'                => __( 'Shop Builder', 'porto-functionality' ),
					...
					'params'                  => array(
						array(
							'type'       => 'porto_param_heading',
							'param_name' => 'desc',
							'text'       => __( 'Displays a toggle button or filtering widgets according to "WooCommerce -> Product Archives -> Filter Layout" in Theme Options.', 'porto-functionality' ),
						),
					),
				)
			);
			...
			vc_map(
				array(
					...
					'icon'        => PORTO_WIDGET_URL . 'shop-hooks.png',
					'class'       => 'porto-wpb-widget',
					'category'    => __( 'Shop Builder', 'porto-functionality' ),
			...
			vc_map(
				array(
					...
					'base'     => 'porto_sb_title',
					'icon'        => PORTO_WIDGET_URL . 'archive-title.png',
					'class'       => 'porto-wpb-widget',
					'category' => __( 'Shop Builder', 'porto-functionality' ),
					'params'   => array(
						array(
			...
			vc_map(
				array(
					...
					'icon'     => PORTO_WIDGET_URL . 'archive-desc.png',
					'class'    => 'porto-wpb-widget',
					'category' => __( 'Shop Builder', 'porto-functionality' ),
					'params'   => array(
						array(
		...
		private function add_gutenberg_elements() {
			...
			if ( $load_blocks ) {
				add_action(
					...
					function () {
						wp_enqueue_script( 'porto-sb-blocks', PORTO_FUNC_URL . 'builders/elements/shop/gutenberg/blocks.min.js', array( 'porto_blocks' ), PORTO_FUNC_VERSION, true );
					},
					999
				);
				add_filter(
