'use strict';(function(b,a){b._EPYTA_.widen_ytprefs_wiz=b._EPYTA_.widen_ytprefs_wiz||function(){setTimeout(function(){var f=Math.min(950,a(b).width()-100),h=-1*f/2;a("#TB_window").addClass("epyt-thickbox").animate({marginLeft:h,width:f},150,"swing",function(){a("#TB_window").get(0).style.setProperty("width",f,"important")});a("#TB_overlay").addClass("epyt-thickbox");a("#TB_window iframe").animate({width:f},150)},750)};b._EPYTA_.ytvi_cancel=b._EPYTA_.ytvi_cancel||function(){a(".ytvi-step").hide("fade",
{},500,function(){a(".ytvi-step-1").show("fade",{},500)})};b._EPYTA_.moneyFormat=b._EPYTA_.moneyFormat||function(f){return"$"+parseFloat(f).toFixed(2)};b._EPYTA_.escId=function(f){return"#"+f.replace(/(:|\.|\[|\]|,|=|@)/g,"\\$1")};b._EPYTA_.demoBackgroundColor=function(f,h){setTimeout(function(){a(".vi-story-demo--info").css("background-color",a(b._EPYTA_.escId("vi_js_settings[backgroundColor]")).val())},0)};b._EPYTA_.demoTextColor=function(f,h){setTimeout(function(){a(".vi-story-demo--info *").css("color",
...
function(f){a(".ytprefs-ob-step").removeClass("active-step");setTimeout(function(){b.scrollTo(0,0);f.prev().addClass("active-step")},600)};b._EPYTA_.selectText=function(f){if(document.selection){var h=document.body.createTextRange();h.moveToElementText(f);h.select()}else if(b.getSelection){var k=b.getSelection();h=document.createRange();h.selectNode(f);k.removeAllRanges();k.addRange(h)}};b._EPYTA_.adstxtLookup=function(){b._EPYTA_.adstxtLoading(!0);a.ajax({url:location.protocol+"//"+location.hostname+
"/ads.txt?c="+Date.now(),dataType:"text",type:"get",data:"",headers:{"Cache-Control":"no-cache"},async:!0}).always(function(f,h,k){if("success"===h)switch(k.status){case 200:case 301:case 302:case 304:case 307:b._EPYTA_.adstxtVerify(f);break;default:b._EPYTA_.adstxtVerify("")}else 404==f.status?a.ajax({url:location.protocol+"//"+location.hostname+"/ads.txt",dataType:"text",type:"get",data:"",headers:{"Cache-Control":"no-cache"},async:!0}).always(function(c,d,e){if("success"===d)switch(e.status){case 200:case 301:case 302:case 304:case 307:b._EPYTA_.adstxtVerify(c);
break;default:b._EPYTA_.adstxtVerify("")}else b._EPYTA_.adstxtVerify("")}):b._EPYTA_.adstxtVerify("")})};b._EPYTA_.adstxtVerify=function(f){a.ajax({type:"post",dataType:"json",timeout:12E4,url:b._EPYTA_.wpajaxurl,data:{security:b._EPYTA_.security,action:"my_embedplus_vi_adstxt_status_soft_ajax",current_adstxt:f},success:function(h){2==h.code?a(".nav-tab-adstxt").addClass("nav-tab-valid"):0>=h.code&&a(".nav-tab-adstxt").addClass("nav-tab-invalid");a(".adstxt-verify-message").html(h.message)},error:function(h,
k,c){a(".nav-tab-adstxt").addClass("nav-tab-invalid");a(".adstxt-verify-message").html("Could not validate ads.txt: "+c)},complete:function(){b._EPYTA_.adstxtLoading(!1)}})};b._EPYTA_.adstxtLoading=function(f){f?a(".nav-tab-adstxt").addClass("nav-tab-loading"):a(".nav-tab-adstxt").removeClass("nav-tab-loading")};b._EPYTA_.gbPreviewSetup=function(){b._EPADashboard_.loadYTAPI();b._EPADashboard_.apiInit();b._EPADashboard_.log("YT API GB");b._EPADashboard_.pageReady();"undefined"!==typeof a.fn.fitVidsEP&&
a("body").fitVidsEP();"undefined"!==typeof b._EPADashboard_.embdyn&&b._EPADashboard_.embdyn()};b._EPYTA_.iabAdd=function(f,h,k){f=a('<div class="iab-cat-tag-button" data-tag="'+f+'">'+k+" : "+h+" &times;</div>");a(".iab-cat-tags-display").append(f);a(".iab-cat-tags-display .iab-cat-tag-button").sort(function(c,d){return a(c).text()>a(d).text()?1:-1}).appendTo(".iab-cat-tags-display")};a.fn.ytprefsFormJSON=function(){var f={},h=this.serializeArray();a.each(h,function(){f[this.name]?(f[this.name].push||
(f[this.name]=[f[this.name]]),f[this.name].push(this.value||"")):f[this.name]=this.value||""});return f};a(document).ready(function(){0===b.location.toString().indexOf("https://")&&(b._EPYTA_.wpajaxurl=b._EPYTA_.wpajaxurl.replace("http://","https://"));var f=b.addEventListener?"addEventListener":"attachEvent";(0,b[f])("attachEvent"==f?"onmessage":"message",function(c){var d="";try{if(0===c.data.indexOf("youtubeembedplus")&&0>c.data.indexOf("clientId=")){d=c.data.split("|")[1];0!==d.indexOf("[")&&
(d="<p>"+d+"</p>");if(null===b.tinyMCE||null===b.tinyMCE.activeEditor||b.tinyMCE.activeEditor.isHidden())d=d.replace("<p>","\n").replace("</p>","\n"),"function"===typeof QTags.insertContent?QTags.insertContent(d):send_to_editor(d);else{if(b._EPYTA_.mceBookmark)try{b.tinyMCE.activeEditor.selection.moveToBookmark(b._EPYTA_.mceBookmark)}catch(g){}"undefined"!==typeof b.tinyMCE.execInstanceCommand?b.tinyMCE.execInstanceCommand(b.tinyMCE.activeEditor.id,"mceInsertContent",!1,d):send_to_editor(d);setTimeout(function(){b._EPYTA_.mceBookmark=
null},500)}tb_remove()}else if(0===c.data.indexOf("youtubeextprop")){var e="xdash1"===c.data.split("|")[1]?1:0;e!=b._EPYTA_.dashpre&&a.ajax({type:"post",dataType:"json",timeout:3E4,url:b._EPYTA_.wpajaxurl,data:{action:"my_embedplus_dashpre",dashpre:e},success:function(g){},error:function(g,l,m){},complete:function(){}})}}catch(g){}},!1);a("body").on("click.tbyt","#ytprefs_wiz_button, .ytprefs_wiz_button_widget_text, .ytprefs-onboarding-launch",function(){b._EPYTA_.widen_ytprefs_wiz()});a("body").on("click.tbyt",
"#ytprefs_wiz_button_vi, .ytprefs_wiz_button_vi_widget_text",function(){send_to_editor("<p>[embed-vi-ad]</p>")});a(b).on("resize",b._EPYTA_.widen_ytprefs_wiz);a(document).on("wp-before-tinymce-init.ytprefs-media_button",function(c,d){c=a(d.selector).closest(".wp-editor-wrap").find(".wp-media-buttons");c.find(".ytprefs_media_link").length||(c.append('<a href="'+encodeURI(b._EPYTA_.wizhref)+'" class="thickbox button ytprefs_media_link ytprefs_wiz_button_widget_text" title="Visual YouTube Search Tool and Wizard - For easier embedding"><span></span> YouTube</a>'),
...
mode:"index",intersect:!1,callbacks:{label:function(g,l){return b._EPYTA_.moneyFormat(g.yLabel)},title:function(g,l){return moment(g[0].xLabel).format("LL")}}},scales:{xAxes:[{type:"time",time:{unit:"day",unitStepSize:1,displayFormats:{day:"MMM DD"}},display:!0,scaleLabel:{display:!0,labelString:"Date",fontSize:15,fontColor:"#000000"},ticks:{major:{fontStyle:"bold",fontColor:"#000000"}}}],yAxes:[{display:!0,scaleLabel:{display:!0,labelString:"Revenue",fontSize:15,fontColor:"#000000"},ticks:{callback:function(g,
l,m){return b._EPYTA_.moneyFormat(g)}}}]}}};Chart.defaults.global.defaultFontFamily="'Segoe UI', Roboto, 'Helvetica Neue', 'Helvetica', 'Arial', sans-serif";new Chart(c,d)}else a(".vi-report-error").removeClass("hide"),a(".vi-report").addClass("hide")},error:function(c,d,e){alertify.alert("Sorry, there was a network error. Please try again. If the issue persists, please contact ext@embedplus.com")},complete:function(){}}),a(".ytvi-btn-logout").on("click",function(){var c="",d=a(".iab-cat-tags").val();
...
a(".ytvi-intro-video-modal").on("click",function(c){c.preventDefault();c=Math.min(.8*document.body.clientWidth,800);var d=.5625*c;alertify.YoutubeDialog("BcrNPnWUkVI").set({frameless:!0,resizeable:!0}).resizeTo(c,d)});a("#vi_show_gdpr_authorization").on("change",function(){a(this).is(":checked")?a(".opt_vi_show_privacy_button").show(300):a(".opt_vi_show_privacy_button").hide(300)});if(a(".wrap-ytprefs-onboarding").length){a(".ytprefs-ob-nav-close").on("click",function(){b.parent.tb_remove();b.top.location.reload()});
a(".ytprefs-ob-nav-prev").on("click",function(){b._EPYTA_.onboardPrev(a(this).closest(".ytprefs-ob-step"))});var h,k=escape("http://"+b.location.host.toString());a("#prokeysubmit").on("click",function(){a(this).prop("disabled",!0);a("#prokeyfailed").hide();a("#prokeysuccess").hide();a("#prokeyloading").show();h=a("#opt_pro").val();var c=document.createElement("script");c.src=b._EPYTA_.epbase+"/dashboard/wordpress-pro-validatejp.aspx?simple=1&prokey="+h+"&domain="+k;var d=document.getElementsByTagName("head")[0].appendChild(c);
setTimeout(function(){d.parentNode.removeChild(d)},500);return!1});b.embedplus_record_prokey=function(c){a.ajax({type:"post",dataType:"json",timeout:3E4,url:b._EPYTA_?b._EPYTA_.wpajaxurl:ajaxurl,data:{action:"my_embedplus_pro_record",pro:c?h:""},success:function(d){"success"==d.type?(a("#prokeysuccess").show(),setTimeout(function(){b.location.reload()},3E3)):a("#prokeyfailed").show()},error:function(d,e,g){a("#prokeyfailed").show()},complete:function(){a("#prokeyloading").hide();a("#prokeysubmit").prop("disabled",
!1)}})};a(".ytprefs-ob-filter li").hover(function(){var c="."+a(this).find('input[type="checkbox"]').data("obfilter")+"-icon";a(c).addClass("yob-icon-visible")},function(){var c="."+a(this).find('input[type="checkbox"]').data("obfilter")+"-icon";a(c).removeClass("yob-icon-visible")});a('.ytprefs-ob-filter input[type="checkbox"]').on("change",function(){var c=a(this),d=c.data("obfilter"),e=a('.ytprefs-ob-filter input[type="checkbox"]:checked');!e.length||1===e.length&&e.is('[data-obfilter="yob-monetize"]')?
a(".ytprefs-ob-step1 .ytprefs-ob-nav-next").prop("disabled",!0):a(".ytprefs-ob-step1 .ytprefs-ob-nav-next").prop("disabled",!1);"yob-monetize"==d?a(".ytprefs-ob-step3 .ytprefs-ob-nav-ultimate, .ytprefs-ob-step3 .ytprefs-ob-nav-penultimate").toggleClass("ytprefs-ob-nav-hide"):c.is(":checked")?a(".ytprefs-ob-step2 ."+d).addClass(d+"-visible"):a(".ytprefs-ob-step2 ."+d).removeClass(d+"-visible")});a(".ytprefs-ob-step1 .ytprefs-ob-nav-next").on("click",function(){b._EPYTA_.onboardNext(a(this).closest(".ytprefs-ob-step"))});
a("#form-onboarding").on("submit",function(c){c.preventDefault();(b.tinyMCE||b.tinymce).triggerSave();var d=a(this);d.find(".ytprefs-ob-nav-next").prop("disabled",!0);c=d.ytprefsFormJSON();c.security=b._EPYTA_.security;a.ajax({type:"post",dataType:"json",timeout:3E4,url:b._EPYTA_?b._EPYTA_.wpajaxurl:ajaxurl,data:c,success:function(e){if("success"==e.type)b._EPYTA_.onboardNext(d.closest(".ytprefs-ob-step"))},error:function(e,g,l){},complete:function(){d.find(".ytprefs-ob-nav-next").prop("disabled",
!1)}})});a(".ytprefs-ob-step3 .ytprefs-ob-nav-skip").on("click",function(){b._EPYTA_.onboardNext(a(this).closest(".ytprefs-ob-step"))});a("#form-onboarding-apikey").on("submit",function(c){c.preventDefault();var d=a(this);d.find(".ytprefs-ob-nav-next").prop("disabled",!0);c=d.ytprefsFormJSON();c.security=b._EPYTA_.security;a.ajax({type:"post",dataType:"json",timeout:3E4,url:b._EPYTA_?b._EPYTA_.wpajaxurl:ajaxurl,data:c,success:function(e){if("success"==e.type)if(d.find(".ytprefs-ob-nav-ultimate").hasClass("ytprefs-ob-nav-hide"))b._EPYTA_.onboardNext(d.closest(".ytprefs-ob-step"));
else b.parent.tb_remove(),b.top.location.reload()},error:function(e,g,l){},complete:function(){d.find(".ytprefs-ob-nav-next").prop("disabled",!1)}})})}a(".epyt-load-dashboard-confirm").on("change",function(){a(".epyt-load-dashboard").prop("disabled",!a(".epyt-load-dashboard").prop("disabled"))});a(".epyt-load-dashboard").on("click",function(){a(".epyt-dashboard-content").attr("src",a(".epyt-dashboard-content").data("src")+encodeURIComponent(b.location.protocol+"//"+b.location.hostname)).css("height",
"calc(100vh - 30px)")})});a(b).on("load",function(){"1"!=_EPYTA_.onboarded&&a(".ytprefs-onboarding-launch").trigger("click")})})(window,jQuery);
